...
const STEPS: Step[] = [
  {
    ...
    text: "Rundt 1200 mennesker sover. Fibernettet går fra noden øverst til høyre ut i alle gatene, og lyspulsene frakter internett og TV som vanlig.",
    log: ["03.51 Alle kabler i Elvelia er normale."],
  },
  {
    time: "03.53",
    title: "Skredet går",
    text: "Skråningen ved bekken raser ut, og kabelen i Elvestien ryker to steder. Operatøren måler fra noden hvor langt ute bruddene er. Det andre bruddet finnes ved å måle rundt ringen, fra den andre enden av kabelen.",
    log: ["03.53 Brudd i Elvestien, 382 m fra noden.", "03.53 Brudd i Elvestien, 531 m målt rundt ringen."],
  },
  {
    time: "03.56",
    title: "Skredet vokser",
    text: "Nye brudd i Lyngveien viser at skredet spiser seg bakover mot nord. Tidspunktene forteller hvilken vei det går, og hvor fort.",
    log: [
      "03.55 Brudd i Lyngveien, 299 m fra noden.",
      "03.56 Brudd i Lyngveien, 465 m målt rundt ringen.",
      "03.56 Skredet vokser mot nord.",
    ],
  },
  {
    time: "04.02",
    title: "Første omriss",
    text: `Bruddene gir et første omriss av skredet. ${HOUSES_IN_ESTIMATE} hus ligger innenfor, og nordkanten er ukjent fordi ingen kabel krysser der. Kartet med forslag til evakueringssone går til innsatsleder, AMK og helikopteret. På Gjerdrum kom første helhetsbilde over en time etter skredet.`,
    log: [
      "04.02 Omriss og evakueringssone sendt til innsatsleder, AMK og helikopter.",
      "04.02 Usikkert: nordkanten mellom Lyngveien og Bjørkeveien.",
    ],
  },
  {
    time: "06.30",
    title: "Fiberen lytter",
    text: `Fiberlytterne har koblet et lytteinstrument på de hele fibrene rundt skredet, fra noden og trygt unna faresonen. ${LISTEN_METERS} meter fiber lytter nå etter bevegelse i grunnen. Gult betyr at bevegelsen øker nær kanten.`,
    log: ["06.30 Lytting aktiv rundt hele skredkanten.", "06.31 Helikopter og aggregat filtrert bort som støy."],
  },
  {
    time: "07.14",
    title: "Varsel: grunnen beveger seg",
    text: "Fiberen langs Solbakken måler raskt økende bevegelse 25 meter fra kanten. Varselet går rett ut på sambandet, og mannskapene trekker seg tilbake. Et minutt senere raser kanten ut der de sto.",
    log: [
      "07.13 Økende bevegelse langs Solbakken.",
      "07.14 VARSEL på sambandet: trekk tilbake fra Solbakken.",
      "07.15 Nytt ras ved Solbakken. Ingen skadet.",
    ],
  },
  {
    time: "Døgn 2",
    title: "Rolig grunn",
    text: "Tolv timer uten målt bevegelse langs kanten. Sammen med NVEs vurdering gir målingene innsatsleder et grunnlag for å starte søket i skredgropa fra bakken, med lyttingen som vakt.",
    log: ["Døgn 2: Ingen bevegelse de siste 12 timene.", "Døgn 2: Søk fra bakken starter, med lytting som vakt."],
  },
  {
    time: "Uke 3",
    title: "Hjem igjen",
    text: "Lyttingen har gått døgnet rundt mens skråningen sikres. Der målingene har vært rolige lenge, friskmelder kommunen sonene etter råd fra NVE. Beboerne i Bjørkeveien og på omsorgssenteret kan flytte hjem.",
    log: ["Uke 3: Sonene i nord og øst er friskmeldt.", "Uke 3: Området nærmest skredet er fortsatt stengt og overvåkes."],
  },
];
